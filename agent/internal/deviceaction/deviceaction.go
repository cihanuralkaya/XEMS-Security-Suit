...
// KAPALI, (3) ajan açıkça ARM'lı (XEMS_ALLOW_WIPE=1). Üçü de sağlanmadıkça WIPE yalnız
...
// (XEMS_ALLOW_WIPE=1 değil) döner — kazara veri kaybını önleyen üçüncü güvenlik katmanı.
var ErrWipeNotArmed = errors.New("deviceaction: WIPE ARM'lanmadı — gerçek silme için ajanda XEMS_ALLOW_WIPE=1 gerekir")
...
// Yalnız XEMS_ALLOW_WIPE=1 iken true. Sunucu RBAC'ı ve güvenli-moddan BAĞIMSIZ EK bir
// kilittir; üretim-dışı/yanlış yapılandırılmış dağıtımlarda kazara wipe'ı önler.
func WipeArmed() bool { return os.Getenv("XEMS_ALLOW_WIPE") == "1" }
